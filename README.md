...
- [Pull Request #2187](https://github.com/dolthub/doltgresql/pull/2187) (2026-01): Add `dolt_status_ignored` system table adapter for new Dolt system table added in dolthub/dolt#10227.
