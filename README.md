...
- [Pull Request #10549](https://github.com/dolthub/dolt/pull/10549) (2026-03): Add `--no-overwrite-ignore` and `--overwrite-ignore` to `dolt checkout` to abort or allow branch switches that would overwrite ignored tables.
